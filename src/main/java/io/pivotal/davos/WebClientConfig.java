...
public class WebClientConfig {
    ...
    @Bean
    @ConditionalOnProperty(name = "davos.uaa.sslValidationSkipped", havingValue="true")
    ...
    @Bean
    @ConditionalOnProperty(name = "davos.uaa.sslValidationSkipped", havingValue="false", matchIfMissing=true)
